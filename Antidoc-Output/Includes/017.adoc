...
"ControlProperty.vi"[color=darkgray shape=invhouse]
" \"Disabled\": Value Change "[color=coral shape=diamond]
...
"ControlProperty.vi" -> " \"Macro: Initialize\" " [dir=both color=cornflowerblue  arrowhead=normal arrowtail=none style=filled penwidth=1];
