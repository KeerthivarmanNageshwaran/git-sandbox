...
"BasicControls.vi"[color=darkgray shape=invhouse]
...
"BasicControls.vi" -> " \"Macro: Initialize\" " [dir=both color=cornflowerblue  arrowhead=normal arrowtail=none style=filled penwidth=1];
